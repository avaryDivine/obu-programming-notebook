...
import {returnItem, returnCategory, addItem, deleteItem, updateItem, returnCloset} from "./api.js"
...
app.post("/return-closet", function(req,res) {
    console.log("/return-closet");

    let the_closet = returnCloset();
    res.json(the_closet);
})
