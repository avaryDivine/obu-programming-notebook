...
<html> encloses everything but the <!DOCTYPE html>
<head> element contains the document title, document metadata, and various other elements that are typically not displayed in the webpage.
